class Yukselen {
  ...
  Yukselen(this._title, this._priority, this._date, [this._description]);

  Yukselen.withId(this._id, this._title, this._priority, this._date,
      [this._description]);
